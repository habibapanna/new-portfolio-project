...
const Counts = () => {
  ...
  return (
    <div className="px-5 lg:p-6 bg-black">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 px-5">
        ...
        <div className="flex flex-row gap-5 lg:w-1/4 mb-10">
          <div>
            <BsEmojiSmile className=" text-5xl text-blue-800" />
          </div>
        ...
        <div className="flex flex-row gap-5 lg:w-1/4 mb-10">
          <div>
            <GoProjectRoadmap className="text-5xl text-blue-800" />
          </div>
          <div className="text-left">
        ...
        <div className="flex flex-row gap-5 lg:w-1/4 mb-10">
          <div>
            <SlEarphonesAlt className="text-5xl text-blue-800" />
          </div>
          <div className="text-left">
        ...
        <div className="flex flex-row gap-5 lg:w-1/4 mb-10">
          <div>
            <HiOutlineUsers className="text-5xl text-blue-800" />
          </div>
          <div className="text-left">
