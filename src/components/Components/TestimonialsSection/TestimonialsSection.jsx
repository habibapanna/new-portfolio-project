              ...
              >
                <div className="bg-white roun relative p-5 shadow-xl w-full max-w-sm cursor-pointer hover:scale-105 transition-transform duration-300">
                  <p className="italic text-sm font-light mb-6 text-center text-black">
                    <FaQuoteLeft className="text-blue-800 mb-2 inline-block mr-2" />
                    {t.text}
                    <FaQuoteRight className="text-blue-800 inline-block ml-2" />
                  </p>
      ...
      <AnimatePresence>
        {openSlider && (
          ...
          >
            ...
            <button
              onClick={handlePrev}
              className="absolute left-3 sm:left-8 text-white md:text-4xl sm:text-5xl hover:text-blue-800 cursor-pointer z-50 hover:bg-white bg-blue-800 border border-pink-500 bg-opacity-60 p-2 rounded-full"
            >
              <IoArrowBack />
            </button>
            ...
            <button
              onClick={handleNext}
              className="absolute right-3 sm:right-8 text-white md:text-4xl sm:text-5xl hover:text-blue-800 cursor-pointer z-50 border border-pink-500 hover:bg-white bg-blue-800 bg-opacity-60 p-2 rounded-full"
            >
              <IoArrowForward />
            </button>
            ...
            >
              <p className="italic text-base sm:text-lg text-gray-200 mb-6 leading-relaxed">
                <FaQuoteLeft className="text-blue-800 inline-block mr-2" />
