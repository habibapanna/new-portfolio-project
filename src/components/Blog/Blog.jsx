          ...
          item.type === "post" ? (
            ...
            >
              ...
              <div className="p-6">
                <h2
                  ...
                  className="text-xl font-bold mb-3 text-white leading-snug cursor-pointer hover:text-blue-800"
                >
                  {item.title}
                </h2>
                ...
                <button
                  onClick={() => navigate(`/blog/${item.id}`, { state: item })}
                  className="text-white font-semibold flex items-center gap-2 hover:text-blue-800 cursor-pointer"
                >
                  READ MORE
            ...
            >
              <div className="absolute top-1 md:top-10 left-1/2 -translate-x-1/2">
                <div className="">
                    <ImBubble className="text-5xl md:text-7xl relative text-blue-800"></ImBubble>
                  <TfiQuoteLeft className="text-lg md:text-3xl absolute top-3 left-4 md:top-4 md:left-5" />
                </div>
              </div>
              <p className="text-lg text-white leading-relaxed mt-8 mb-6 hover:text-blue-800 cursor-pointer font-bold">
                {item.text}
              </p>
