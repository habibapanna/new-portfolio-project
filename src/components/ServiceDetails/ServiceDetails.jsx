          ...
          <div className="bg-black border border-gray-300 p-6">
            <ul className="space-y-6">
              {services.map((service, index) => (
                <li
                  key={index}
                  className={`cursor-pointer hover:text-blue-800 pl-4 border-l-3 hover:border-blue-400 ${
                    activeService === service
                      ? "border-blue-400 text-blue-800 font-bold"
                ...
                <ul className="space-y-4">
                  {content.points.map((item, itemIndex) => (
                    <li key={itemIndex} className="flex items-center text-gray-700">
                      <BsCheckCircle className="text-blue-800 mr-2 text-xl" />
                      {item}
                    </li>
                  ))}
                </ul>
