  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 w-full h-1 z-50">
        <div
          className="h-1 bg-blue-400 transition-all duration-500 ease-in-out"
      ...
      <div className="fixed top-5 right-5 z-50 lg:hidden">
        <button
          ...
          className="text-white text-3xl bg-blue-400 rounded-full p-2 shadow-lg hover:scale-110 transition-transform cursor-pointer"
        >
      ...
      >
        ...
        <div className="hidden md:flex flex-col mt-10 relative">
          ...
          <div className="flex justify-between items-center">
            ...
            >
              {menuListOpen ? (
                <AiOutlineClose size={22} className="text-blue-400" />
              ) : (
                <TfiMenuAlt size={25} className="text-blue-400" />
              )}
            </motion.div>
          </div>
        ...
        <div className="hidden lg:flex items-center justify-start absolute left-0 top-1/2 transform -translate-y-1/2 z-[70]">
          ...
          <motion.span
  className="absolute left-45 w-48 h-[1px] bg-blue-400 z-[70]"
  animate={
    showSpread
      ? {
          scaleX: [1, 1.3, 1],
